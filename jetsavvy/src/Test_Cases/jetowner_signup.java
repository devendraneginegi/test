...
import Testdata.jetowner_signup_data;

public class jetowner_signup {
	...
	@Test(dataProviderClass = jetowner_signup_data.class, dataProvider = "jetowner_signup")
	public void signup(String fname,String lname,String email,String password) throws InterruptedException
	{  	 
	  
	  driver.get("https://jetsetter:Jetsavvy!@demob2b.jetsavvy.com/welcome/JETO");	  
	  //Thread.sleep(2000);
