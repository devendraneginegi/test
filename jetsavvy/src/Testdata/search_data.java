...
public class search_data {
	...
	public static Object[][] roundtripsearch()
	{
		...
		data[0][0]= "LOS ANGELES INTL";
		data[0][1]= "JOHN F KENNEDY INTL";
		data[0][2]= "October 19, 2018";
		data[0][3]= "10:00 PM";
		data[0][4]= "10";
		data[0][5]= "October 20, 2018";
		data[0][6]= "11:00 PM";	
		
		data[1][0]= "LOS ANGELES INTL";
		data[1][1]= "JOHN F KENNEDY INTL";
		data[1][2]= "October 21, 2018";
		data[1][3]= "10:00 PM";
		data[1][4]= "11";
		data[1][5]= "October 22, 2018";
		data[1][6]= "11:00 PM";	
		return data;
	}
